			...
			<div class="navbar__inner">
				...
				<nav class="navbar__menu">
					<ul>
						...
						<li><a href="#">Update Customer Details</a></li>
			...
			<div class="app__inner">
				<div class="app__menu">
					<ul class="vMenu">
						...
						<li><a href="customers.php">View Customers</a></li>
						<li><a href="#" class="vMenu--active">Update Customer Details</a></li> 
					</ul>
				</div>
				<div class="app__main">
					<div class="text-container">
						<h1 class="app__main__title" id="form_submit">Update Customer Details</h1>
							<h4><div id=form_submit>You can update the entry with the specific Loan number</div></h4>
							<h1>&nbsp;</h1>
